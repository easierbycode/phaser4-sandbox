...
class TitleScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("laser1", "assets/lasers-bg1.png");
    this.load.image("laser2", "assets/lasers-bg2.png");
    this.load.image("laser3", "assets/lasers-bg3.png");
    this.load.image("laser4", "assets/lasers-bg4.png");

    this.load.image("lights1-yellow-1", "assets/lights1-yellow-1.png");
    this.load.image("lights1-yellow-2", "assets/lights1-yellow-2.png");
    this.load.image("lights1-yellow-3", "assets/lights1-yellow-3.png");
    this.load.image("lights1-yellow-4", "assets/lights1-yellow-4.png");
    this.load.image("lights2-blue-1", "assets/lights2-blue-1.png");
    this.load.image("lights2-blue-2", "assets/lights2-blue-2.png");
    this.load.image("lights2-blue-3", "assets/lights2-blue-3.png");
    this.load.image("lights2-blue-4", "assets/lights2-blue-4.png");
    this.load.image("lights3-green-1", "assets/lights3-green-1.png");
    this.load.image("lights3-green-2", "assets/lights3-green-2.png");
    this.load.image("lights3-green-3", "assets/lights3-green-3.png");
    this.load.image("lights3-green-4", "assets/lights3-green-4.png");
    this.load.image("lights4-purple-1", "assets/lights4-purple-1.png");
    this.load.image("lights4-purple-2", "assets/lights4-purple-2.png");
  ...
  create() {
    ...
    this.backgrounds = [];
    if (typeof ScrollingBackground !== 'undefined') {
      for (var i = 0; i < 3; i++) {
    ...
    this.anims.create({
      key: "titleMusicNotes",
      frames: this.anims.generateFrameNumbers("music-notes", {
        start: 0,
        end: 7,
      }),
      frameRate: 17,
    ...
    this.titleText = this.add
      .text(this.scale.width * 0.5, this.scale.height * 0.2, "SHOOTY\nBEARS", {
  ...
  spawnMusicNotes() {
    ...
    this.musicNotes.setTint(
      Phaser.Utils.Array.GetRandom([
        0x55eeff, 0x5403f700, 0xd627bc, 0xd4af37, 0xeeaa00, 0xeecc66, 0xfcdb06,
      ])
    );
